...
class RouterScraper(private val context: Context) {
    ...
    suspend fun scrapeRouterData(
        ...
        username: String,
        password: String,
        onStatusUpdate: (com.prajwal.utilities.data.models.ScrapingStatus) -> Unit = {}
    ): ScrapedData = withContext(Dispatchers.Main) {
        // Add timeout wrapper
        withTimeout(30000) { // 30 second timeout
            suspendCancellableCoroutine { continuation ->
                
                onStatusUpdate(com.prajwal.utilities.data.models.ScrapingStatus.CONNECTING)
                        ...
                        when {
                            ...
                            url == "http://$routerIp/" -> {
                                ...
                                if (!loginAttempted) {
                                    ...
                                    onStatusUpdate(com.prajwal.utilities.data.models.ScrapingStatus.LOGGING_IN)
                                    loginAttempted = true
                                    ...
                                    fun tryLogin() {
                                        ...
                                        view?.evaluateJavascript(loginScript) { result ->
                                            ...
                                            if (status == "success") {
                                                 ...
                                                 onStatusUpdate(com.prajwal.utilities.data.models.ScrapingStatus.NAVIGATING)
                            ...
                            url?.contains("traffic_wan_frame2.cgi") == true -> {
                                ...
                                onStatusUpdate(com.prajwal.utilities.data.models.ScrapingStatus.SCRAPING_DATA)
                                val scrapeScript = """
                                    (function() {
